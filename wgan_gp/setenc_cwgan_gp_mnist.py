...
from dataset import MNISTSummation
...
parser.add_argument("--set_size", type=int, default=10, help="size of the sets")
...
for epoch in range(opt.n_epochs):
    for b, (imgs, labels) in enumerate(dataloader):
        ...
        if b % opt.n_critic == 0:
            ...
            ids = (gen_labels != gen_labels[p_dest]).squeeze(1)
    ...
    if epoch % 5 == 0:
        ...
        plt.legend()
        plt.savefig("tsne/tsne_%d.png" % epoch)
