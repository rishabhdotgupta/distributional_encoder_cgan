...
for epoch in range(opt.n_epochs):
    for b, (imgs, labels) in enumerate(dataloader):
        ...
        if b % opt.n_critic == 0:
            ...
            fake_validity = (discriminator(fake_imgs_src, src_labels) + discriminator(fake_imgs_dest, dest_labels)) / 2
            ...
            fake_imgs_mid = generator(z, src_labels, dest_labels)
            ...
            euc = torch.norm(enc_src - enc_dest, p=2, dim=1)
